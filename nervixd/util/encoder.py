...
class BaseEncoder:
    ...
    def write_to_file(self, fd, chunksize=None):
        """
        Write bytes from the internal chunkbuffer to the given file
        descriptor. The number of written bytes is limited by the given
        chunksize, if not given, the default chunksize (specified via __init__)
        will be used.
        """
